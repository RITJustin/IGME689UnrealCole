...
#include "colea4v8PlayerController.generated.h"
 ...
 */
UCLASS(abstract)
class Acolea4v8PlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<Acolea4v8Pawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<Acolea4v8Pawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<Ucolea4v8UI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<Ucolea4v8UI> VehicleUI;
