...
#include "colea4v8OffroadCar.h"
#include "colea4v8OffroadWheelFront.h"
#include "colea4v8OffroadWheelRear.h"
...
Acolea4v8OffroadCar::Acolea4v8OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = Ucolea4v8OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = Ucolea4v8OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = Ucolea4v8OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = Ucolea4v8OffroadWheelRear::StaticClass();
