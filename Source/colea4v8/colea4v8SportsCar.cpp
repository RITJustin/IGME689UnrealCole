...
#include "colea4v8SportsCar.h"
#include "colea4v8SportsWheelFront.h"
#include "colea4v8SportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

Acolea4v8SportsCar::Acolea4v8SportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = Ucolea4v8SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = Ucolea4v8SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = Ucolea4v8SportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = Ucolea4v8SportsWheelRear::StaticClass();
